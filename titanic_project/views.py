...
#         # Data ko DataFrame mein convert kar rahe hain
#         df = pd.DataFrame([[pclass, age, sibsp, parch, fare, sex, embarked]],
#                           columns=['Pclass', 'Age', 'SibSp', 'Parch', 'Fare', 'Sex', 'Embarked'])
...
#         # Final dataframe mein required columns select kar rahe hain
#         df = df[required_columns]

#         # Model ke through prediction kar rahe hain
#         pred = model.predict(df)[0]

#         # Prediction ko result ke form mein return kar rahe hain
#         if pred == 1:
#             result = 'Survived'
#         else:
#             result = 'Did not Survive'

#         # Result ko render kar ke user ko display kar rahe hain
#         return render(request, 'index.html', {'result': result})

#     # Agar POST request nahi hai, to empty page render karenge
#     return render(request, 'index.html')